...
static const int MAX_OUTBOUND_CONNECTIONS = 32;//16; connection increase
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AXFunds is probably already running."), addrBind.ToString());
        else
