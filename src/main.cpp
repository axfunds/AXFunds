...
CBigNum bnProofOfStakeLimitV2(~uint256(0) >> 7);

int nStakeMinConfirmations = 10;
unsigned int nStakeMinAge = 5 * 60; // 5 min.  1 * 60 * 60; //1 hour  -- 1*60 =  1 minute
...
static const int64_t nTargetTimespan =  16*60; //16*60 ; // 16 mins
